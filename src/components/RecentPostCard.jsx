        ...
        <>
            <div className="flex flex-row gap-6 group">
                <div className="w-20 h-20 flex-shrink-0 overflow-hidden rounded-md">
                    ...
                    group-active:transform group-active:scale-110 group-active:-rotate-3
                     transition-all duration-500 ease-in-out" />
                </div>
                <div className="flex flex-col justify-between">
                    <h3 className="font-semibold line-clamp-2 cursor-pointer">
                        <a className="line-effect text-base font-semibold 
                        hover:outline-none hover:[text-decoration:none] hover:border-none">
                            {post.title}
                        </a>
                    </h3>
