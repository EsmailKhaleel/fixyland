    ...
    return (
        ...
        >
            <img
                src={image}
                alt="luxury hotel"
                className="absolute inset-0 w-full h-full object-cover rounded-xl -z-10 group-hover/offer:scale-110 group-hover/offer:-rotate-3 transition-all duration-600 ease-in-out"
            />
