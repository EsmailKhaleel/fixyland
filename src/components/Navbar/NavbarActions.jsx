...
function NavbarActions({ isSticky = false, isDrawerOpen, setIsDrawerOpen }) {
    return (
        <div className="flex gap-4 items-center mr-4">
            ...
            <div className={`hidden xl:flex group ${isSticky ? 'bg-gray/10 hover:bg-gray/20' : 'bg-white/10 hover:bg-white/20'} items-center justify-center flex p-4.5 rounded-full transition-all duration-300 cursor-pointer`}>
