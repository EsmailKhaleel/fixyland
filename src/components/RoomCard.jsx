        ...
        <div className="w-full max-w-lg overflow-hidden flex flex-col gap-3 sm:gap-2">
            ...
            <div className="relative mb-3 sm:mb-4 overflow-clip rounded-lg sm:rounded-xl">
                <img
                    src={room.image}
                    alt={room.title}
                    className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover rounded-lg sm:rounded-xl hover:transform hover:scale-110 hover:-rotate-3 focus:transform focus:scale-110 focus:-rotate-3 active:transform active:scale-110 active:-rotate-3 transition-all duration-500 ease-in-out"
                    draggable={false}
                />
            ...
            {/* Read More Button */}
            <button
                className="self-start relative group flex items-center space-x-2 mb-2 sm:mb-4 text-primary/90 hover:text-primary focus:text-primary active:text-primary font-medium transition-all
