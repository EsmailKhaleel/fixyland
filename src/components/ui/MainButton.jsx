...
function MainButton({
  ...
  return (
    <button
      className={`relative overflow-hidden min-w-[200px] group text-md font-medium px-6 py-4 transition cursor-pointer flex justify-between items-center gap-4 ${borderRadius} ${bgColors[color]} ${textColors[textColor]}`}
      onClick={onClick}
    >
