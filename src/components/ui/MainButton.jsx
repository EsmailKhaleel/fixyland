...
function MainButton({
  ...
  return (
    <button
      className={`relative overflow-hidden min-w-[200px] group text-md font-medium px-6 py-4 rounded-sm transition cursor-pointer flex justify-between items-center gap-1 ${bgColors[color]} ${textColors[textColor]}`}
      onClick={onClick}
    >
