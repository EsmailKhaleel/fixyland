        ...
        <div className="w-full max-w-lg overflow-hidden flex flex-col gap-2 h-full">
            ...
            <div className="relative mb-4 overflow-clip rounded-xl">
                <img
                    src={blog.image}
                    alt={blog.title}
                    className="w-full h-96 object-cover rounded-xl hover:transform hover:scale-110 hover:-rotate-3 transition-all duration-500 ease-in-out"
                    draggable={false}
                />
